...
/**
 * This is used to create tables in PDF.
 * @author averma
 *
 */
public class PdfTable {
    ...
    /**
     * Create a pdf Table
     * @param yPos - y Position from page bottom
     * @param margin
     * @param page - the page to which this table belongs
     * @param contentStream - Stream in which this table will be written
     */
    ...
    /**
     * Draw line at table bottom
     * @param width - Specify the line width
     * @throws IOException
     */
    ...
    /**
     * Check if table has reached end of page.
     * If we are closer than 75 from bottom of page, consider this the end of the page (for rows of height 75 or less)
     * @return
     */
